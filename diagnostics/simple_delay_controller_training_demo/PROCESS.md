...
- `reward_state_information_stochastic_0_40.png`: unseen vs augmented reward convergence at stochastic `(0-40,0-40)`, generated from `../simple_delay_controller_training_demo_stochastic_0_40/results.csv`.
...
- The stochastic comparisons use stochastic action and observation ranges because this run used `--stochastic-mode both`.
